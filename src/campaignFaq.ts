  ...
  private getFaq() {
    if(this.campaign && this.campaign.faqs) {
      for (let key in this.campaign.faqs) {
        if (this.campaign.faqs && 
          this.campaign.faqs[key].disabled === false) {
          this.campaignFaq = html`<div class='faq-title'>
            <div class='faq-name'>
              ${this.campaign.faqs[key].name}
            </div>
          ...
          for (let index in this.campaign.faqs[key].faq_pairs) {
            if (this.campaign.faqs[key].faq_pairs && 
              this.campaign.faqs[key].faq_pairs[index].disabled === false) {
              this.campaignFaq = html`${this.campaignFaq} <div class='faq-pair'>
          ...
          this.campaignFaq = html`<div class='faq-group'>${this.campaignFaq}</div>`;
        }
      }
      this.campaignFaq = html`<div class='faq-container'>${this.campaignFaq}</div>`;
    }
  }
