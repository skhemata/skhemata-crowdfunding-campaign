...
## Installation
```bash
npm i skhemata-crowdfunding-campaign
```

## Usage
```html
<script type="module">
  import 'skhemata-crowdfunding-campaign/skhemata-crowdfunding-campaign.js';
</script>

<skhemata-crowdfunding-campaign></skhemata-crowdfunding-campaign>
```
